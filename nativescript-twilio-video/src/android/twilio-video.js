...
var VideoActivity = (function() {
  ...
  VideoActivity.prototype.connect_to_room = function(roomName, options) {
    ...
    var connectOptionsBuilder = new ConnectOptions.Builder(
      this.accessToken
    ).roomName(roomName);
  ...
  VideoActivity.prototype.addRemoteParticipant = function(remoteParticipant) {
    if (remoteParticipant.getRemoteVideoTracks().size() > 0) {
      var remoteVideoTrackPublication = remoteParticipant
  ...
  VideoActivity.prototype.removeRemoteParticipant = function(
    remoteParticipant
  ) {
  ...
  VideoActivity.prototype.participantListener = function() {
    ...
    return new Participant.Listener({
      ...
      onAudioTrackSubscribed: function(
        remoteParticipant,
      ...
      onAudioTrackUnsubscribed: function(
        remoteParticipant,
        remoteAudioTrackPublication,
        remoteAudioTrack
      ) {
      ...
      onVideoTrackSubscribed: function(
        remoteParticipant,
      ...
      onVideoTrackUnsubscribed: function(
        remoteParticipant,
        remoteVideoTrackPublication,
        remoteVideoTrack
      ) {
